...
# CODEX_MODEL_REASONING_SUMMARY overrides model_reasoning_summary. Default to
# detailed to preserve the pre-Codex-0.139 behavior where reasoning summaries
# were emitted without a deployment opt-in.
summary = os.environ.get("CODEX_MODEL_REASONING_SUMMARY", "detailed").strip()
