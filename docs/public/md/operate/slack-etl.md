...
| `slack_backfill` | 5 minutes | Claims queued backfill jobs and drains Slack cursors without slowing the incremental sync. |
...
| `SLACK_BACKFILL_INTERVAL_SECONDS` | `300` | How often to drain queued backfill jobs. |
