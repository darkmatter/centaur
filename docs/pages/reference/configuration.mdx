...
| `CODEX_MODEL_REASONING_SUMMARY` | `sandbox.extraEnv`. | Sets `model_reasoning_summary` in the Codex config (`auto`, `concise`, `detailed`, `none`; default `detailed` to preserve the pre-Codex-0.139 thinking trace). |
